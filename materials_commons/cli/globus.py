...
class GlobusOperations(object):
    ...
    def upload_v0(self, proj, paths, recursive=False, label=None):
        ...
        tdata = globus_sdk.TransferData(self.tc, self.local_endpoint_id, req.globus_endpoint_id, label=label)
        ...
        for p in paths:
            ...
            self.create_all_directories_on_path(os.path.dirname(relpath), req.globus_endpoint_id, req.globus_endpoint_path)
    ...
    def download_v0(self, proj, paths, recursive=False, label=None, localtree=None, remotetree=None):
        ...
        # https://globus-sdk-python.readthedocs.io/en/stable/clients/transfer/#globus_sdk.TransferData
        tdata = globus_sdk.TransferData(self.tc, req.globus_endpoint_id, self.local_endpoint_id, label=label)
