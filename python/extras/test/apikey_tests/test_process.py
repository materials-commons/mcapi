...
class TestProcess(unittest.TestCase):
    ...
    def test_process_link_process_with_samples(self):
        ...
        ht_template = _template_id_with(self.templates, "Heat Treatment")
...
class TestProcessProperties(unittest.TestCase):
    ...
    def test_set_known_setup_property(self):
        ...
        property = table['temperature']
        self.assertEqual(100, property.value)
        self.assertEqual('C', property.unit)
...
def _template_id_with(template_table, match):
    found_id = None
